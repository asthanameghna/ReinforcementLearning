...
class MountainCar:
    ...
    def reset(self):
        ...
        if self.fixed_starts:
            self.position, self.velocity = (-0.5, 0.)
        else:
            # In S&B (1998), starting position and velocity are chosen uniformly among the whole range of values.
            ...
            # self.velocity = np.random.uniform(low=-0.01, high=+0.01)
